        ...
        <div class="fungible_card">
            ...
            <div class="alt_info">
                ...
                <div class="alt_breakdown" v-else>
                    ...
                    <div v-if="hasMultisig">
                        <label>Multisig (N)</label>
                        <p>{{ avmMultisig | cleanAvaxBN }} SOPHON</p>
                        <label>Multisig (E)</label>
